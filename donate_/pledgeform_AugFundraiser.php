...
function validate(){
  ...
  if (pledgeform.fullname.value.length<=1) {
    alert("Please enter your full name");
    return false;
  }
  else if (pledgeform.address.value.length<=1) {
    alert("Please enter your Address");
    return false;

  }
  else if (pledgeform.phone.value.length<=1) {
    alert("Please enter your Phone Number");
    return false;
  }
  else if (pledgeform.email.value.length<=1) {
    alert("Please enter your Email Address");
    return false;
  }
  else if (pledgeform.amount.value.length<=0) {
    alert("Please enter your Pledge Amount");
    return false;
  }
}
</script>
...
<title>Berkeley Masjid - Pledge Form</title></head><body><div id="body"><div id="doc"><div xmlns="" id="hd">
<style>
...
<p>
<form action="pledgesubmit.php" method="post" name="pledgeform" id="pledgeform" onsubmit="return validate();">
<table border="0" width="100%" cellspacing="0" cellpadding="0">

<tr>
	<td width="40%">Name:</td> <td width="60%"><input type="text" size="50" name="fullname"><font color="red">*</font></td>

</tr>
<tr>

	<td width="40%">Full Address:</td> <td><input type="text" size="50" name="address"><font color="red">*</font></td>
</tr>
<tr>

	<td width="40%">Email:</td> <td><input type="text" size="50" name="email"><font color="red">*</font></td>
</tr>
<tr>
	<td width="40%">Phone:</td> <td><input type="text" size="15" name="phone"><font color="red">*</font></td>
</tr>
<tr>
	<td width="40%">Pledge Amount ($):</td> <td><input type="text" size="15" name="amount"><font color="red">*</font></td>
</tr>

<tr>
	<td width="40%">Installments:</td> <td>
...
<td>
<textarea name ="comment" rows="6" cols="40">Dear Berkeley Masjid Foundation. Please accept my pledge towards the Berkeley Masjid construction. You may use my pledge to match funds at the August 1st fundraising dinner.</textarea>

</td>
</tr>
<tr>
<td align="center" colspan="2"><input type="submit" value="submit" id="submit"></td>
</table>

</form>


 <font color="red"><b>*</b></font> <font size="1">Required Fields</font><br />
</p>
